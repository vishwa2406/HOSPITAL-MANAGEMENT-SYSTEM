...
import { Heart, Brain, Bone, Baby, Eye, Stethoscope, Activity, ArrowRight } from "lucide-react";
    ...
    <section id="services" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-display font-bold text-slate-900 mb-4">Our Medical Services</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {items.map((s, i) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-primary transition-colors">{s.title}</h3>
              <p className="text-slate-600 mb-6 leading-relaxed text-sm">{s.description}</p>
